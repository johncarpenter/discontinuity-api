...
const people = [
  ...
  {
    name: "OpenAI/LLAMA/Midjourney/Dalle/Anthropic",
    role: "Digital Creative Partners",
    imageUrl: "/static/images/robo_dalle.jpeg",
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-5">
        <div className="max-w-2xl xl:col-span-2">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
            Meat-Based and Digital partners working together to create a new
            future of work.
          </p>
        </div>
        <ul
          ...
          {people.map((person) => (
            ...
            >
              ...
              <div className="max-w-xl flex-auto">
                <h3 className="text-lg font-semibold leading-8 tracking-tight text-gray-800 dark:text-gray-300">
                  {person.name}
                </h3>
                <p className="text-base leading-7 text-secondary-600">
                  {person.role}
                </p>
