...
export default function ContactForm() {
  ...
  const submit = async (e) => {
    ...
    if (error) {
      setError(true);
      setMessage(
        "We are Sorry Something Went Wrong. Please contact us at hello@discontinuity.ai"
      );
      return;
    }
          ...
          <div className="mx-auto max-w-4xl lg:mx-0 lg:max-w-lg">
            <div className="flex flex-col items-center">
              ...
              <p className="text-center mt-5 text-gray-600">
                We&apos;d love to hear more about your projects and how we can
                help. Fill out the form below and we&apos;ll contact you as soon
                as possible.
              </p>
            </div>
