...
export default function SupportPage() {
  return (
    <Container>
      ...
      <LicenseCard />
      <Card>
        <Card.Body title="Contact Support" subtitle="Get help with your account">
            ...
            <div className="mx-auto max-w-lg space-y-16">
              <div className="flex gap-x-6">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-gray-600">
                    For customers with active licenses, we offer email support with a 24 hour
                    response
                  </p>
                  <p className="mt-4">
                    <a
                      href="mailto:support@blacksquare.io"
              ...
              <div className="flex gap-x-6">
                ...
                <div>
                  ...
                  <p className="mt-4">
                    <a
                      href="mailto:sales@blacksquare.io"
                      className="text-sm font-semibold leading-6 text-primary-600"
                    >
