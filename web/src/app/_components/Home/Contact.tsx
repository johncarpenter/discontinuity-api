        ...
        <div className="relative px-6 pb-10 pt-4 sm:pt-14 lg:static lg:px-8 lg:py-4">
          <div className="mx-auto max-w-4xl lg:mx-0 lg:max-w-lg">
            <div className="flex flex-col space-y-5">
              <span className="text-secondary-600 uppercase">Join the Beta Waitlist Program</span>
              <h2 className="text-4xl font-bold ">
                <span className="block">Beta Waitlist Program</span>
              </h2>
              <p className=" mt-5 text-gray-600">
                Signup today to be the first to access our beta program. We will notify you when we
                are ready to launch.
              </p>
            </div>
