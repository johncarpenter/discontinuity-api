  ...
  return (
    <>
      <div className="flex flex-col  bg-gray-50 dark:bg-gray-800 dark:text-white h-full w-full min-h-screen">
        ...
        <div className="w-full mx-auto p-4 h-24  bottom-0 fixed bg-gray-50 dark:bg-gray-800 dark:text-white pt-2">
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col w-full relative border dark:text-white rounded-2xl">
              <LightBulbIcon className="absolute left-3 top-4 w-5 h-5" />
              <input
                type="text"
                name="chat"
                id="chat"
                className="m-0 w-full resize-none border-0 bg-transparent ring-0 dark:bg-transparent py-[10px] pr-10 md:py-3.5 md:pr-12 max-h-52 placeholder-black/50 dark:placeholder-white/50 pl-10 md:pl-[55px]"
