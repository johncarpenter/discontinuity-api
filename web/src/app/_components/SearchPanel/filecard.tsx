    ...
    <a href={href}>
      <div className="bg-white px-6 py-6 lg:px-8 overflow-hidden rounded-2xl shadow-xl hover:ring-1 hover:ring-secondary-500 ">
        <div className="col-span-1 flex ">
          <div className="flex items-center justify-center w-48 h-48 rounded-lg">{icon(type)}</div>

          <div className="flex flex-1 items-center justify-between">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-base font-semibold leading-6 text-gray-900">{snippet}</h3>
