            ...
            {isLoaded && userMemberships && userMemberships.data.length > 0 && (
              <div className="flex flex-col items-center justify-center">
                <div className="text-base leading-7 text-gray-700 lg:max-w-lg pb-8">
                  ...
                  <h1 className="mt-2 text-3xl font-bold tracking-tight text-normal sm:text-4xl">
                    You've been invited to join an organization. Choose one to get started.
                  </h1>
                </div>
                <div className="flex flex-col w-full card-normal">
                    ...
                    >
                      <div className="flex rounded-md shadow-sm p-2">
                        ...
                        <div className="flex flex-1 items-center justify-between truncate rounded-r-md ">
                          <div className="truncate px-4 py-2 text-sm text-normal">
