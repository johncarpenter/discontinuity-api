          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-6">
                  AI is radically transforming the way we do work and engage with others, and we are
                  only starting to see its full impact and potential.
                </p>
                <p className="mt-8">
                ...
                <p className="mt-8">
                  Discontinuity.AI can prototype an application in a matter of days, and give it to
                  your team to evaluate. Faster speed means your move faster and can implement AI
                  cheaper. Know the impact of AI before you invest in it.
                </p>
              </div>
              <figure className="relative isolate">
                ...
                <blockquote className="mt-6 text-xl font-semibold leading-8 text-primary-600">
                  <p>
                    “Using generative AI (like ChatGPT) in business improves users’ performance by
                    66%, averaged across 3 case studies. More complex tasks have bigger gains, and
                    less-skilled workers benefit the most from AI use.”
                  </p>
                </blockquote>

                <figcaption className="mt-6 text-sm leading-6 text-gray-700">
                  <strong className="font-semibold text-primary">Jacob Nielsen,</strong> Nielsen
                  Norman Group
                </figcaption>
              </figure>
            </div>
